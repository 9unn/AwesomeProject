                ...
                ({ item, index }) => {
                    ...
                    return (
                        <View style={{marginRight: 10}}>
                            ...
                            <View style={{flexDirection: 'row', height : 75 , width: 300 ,borderColor : 'grey', borderBottomLeftRadius : 10 , borderBottomRightRadius : 10, borderWidth: 1.5}}>
                                
                                <View style>
                                    <Text style={{fontSize: 20, color: 'red',fontWeight: 'bold', textAlign: 'left',marginTop: 10}}>DEC</Text>
                                    <Text style={{fontSize:20, color : "black" ,paddingLeft:10}}>{item.date}</Text>
                                </View>

                                <View>
                                    <Text style={{fontSize: 20, color: 'black',fontWeight: 'bold', textAlign: 'left', padding: 10}}>{item.title}</Text>
                                    <Text style={{ fontSize:20, color : "grey"}}>{item.datetime}</Text>
                                    <Text style={{ fontSize:20, color : "grey"}}>{item.place}</Text>
                                </View>
